 ...
 * @extends MulleState
 */
// Lingo parity: MovieScript 3 (14/14)
// Inventory: Blueprint1, Blueprint2, BluePrint3 — hull size blueprint checks
// State: boatViewHandler — used for boat preview offset calculations
const FB_BLUEPRINT_ITEMS = ['Blueprint1', 'Blueprint2', 'BluePrint3']
const FB_BOAT_VIEW_HANDLER_STATE = 'boatViewHandler'
