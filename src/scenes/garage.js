 ...
 * @module GarageState
 *
 * Lingo parity: ParentScript 2 - Dir.ls (03/03)
 * Audio cues for ambient and dialogue sequences:
 *   00d001v0, 00d002v0, 00d003v0, 00d004v0, 00d005v0
 *   03d002v0, 03d003v0, 03d004v0, 03d005v0, 03d006v0, 03d007v0
 * State: enterShelf (from GoShelf BehaviorScripts)
 */
'use strict'

// Lingo: genDialogList ambient audio shared with shelves
const GARAGE_AMBIENT_AUDIO = [
  '00d001v0', '00d002v0', '00d003v0', '00d004v0', '00d005v0'
]

// Lingo: scene-specific dialogue audio from Dir.ls
const GARAGE_DIALOGUE_AUDIO = [
  '03d002v0', '03d003v0', '03d004v0', '03d005v0', '03d006v0', '03d007v0'
]

// Lingo: GoShelf BehaviorScripts set enterShelf on gMulleGlobals
const GARAGE_ENTER_SHELF_STATE = 'enterShelf'
    ...
    */
    ...
    this.door_garage = new MulleButton(this.game, 320, 240, {
      ...
      click: () => {
        ...
        // 00b015v0: pushing the main garage door from the outside (yard-facing)
        // This matches the "push car outside" transition background.
        this.game.mulle.activeCutscene = 75
    ...
    this.car_camera = MulleButton.fromRectangle(this.game, 589, 62, 41, 117, {
      ...
      click: () => {
        ...
        this.game.mulle.user.activeVehicleType = 'car'
        this.game.mulle.whereFrom = 'garage'
