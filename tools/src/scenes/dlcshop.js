 ...
 * @extends MulleState
 */
// Lingo parity: BehaviorScript 4 / MovieScript 1 (13/13)
// Audio: 04e004v0 — purchase confirmation sound
// Transition: Eldmatch — age verification gate
const DLC_PURCHASE_SOUND = '04e004v0'
const DLC_AGE_GATE_TRANSITION = 'Eldmatch'
...
class DLCShopState extends MulleState {
  ...
  purchaseDLC(packageId, parts) {
    ...
    if (this.game.mulle.playAudio) {
      // STUB: asset not found in ISO — 04e007v0 (purchase success sound)
    }
