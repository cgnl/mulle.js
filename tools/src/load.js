...
class LoadState extends Phaser.State {
  ...
  create () {
    ...
    // Load boat parts database
    var boatParts = this.game.cache.getJSON('BoatPartsDB')
    if (boatParts) {
      for (var id in boatParts) {
        this.game.mulle.BoatPartsDB[id] = new MullePartData(this.game, id, boatParts[id])
      }
      console.log('[Load] Boat parts loaded:', Object.keys(this.game.mulle.BoatPartsDB).length)
    }
